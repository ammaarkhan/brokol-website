    ...
    <div className="bg-background-green fixed top-0 left-0 w-full z-50">
      ...
      {isOpen && (
        <div className="md:hidden bg-background-green">
          <Link href="#demo" className="block text-white px-4 py-2 hover:bg-gray-700">Demo</Link>
          <Link href="#benefits" className="block text-white px-4 py-2 hover:bg-gray-700">Benefits</Link>
          <Link href="#how-it-works" className="block text-white px-4 py-2 hover:bg-gray-700">How It Works</Link>
          <Link href="#testimonials" className="block text-white px-4 py-2 hover:bg-gray-700">Testimonials</Link>
          <Link href="#get-early-access" className="block text-white px-4 py-2 bg-brokol-green hover:bg-gray-700 rounded-lg">Get Early Access</Link>
        </div>
      )}
    </div>
  );
